...
const AdditionalInformation: React.FC = () => {
  ...
  return (
    <div className="rounded-lg bg-white p-6 shadow-md dark:bg-gray-dark dark:text-white">
      ...
      <div className="mb-8 flex w-full justify-between gap-8">
        <div className="flex w-full flex-col gap-4 pt-3 border-r-2 pr-8 text-dark dark:text-white">
          {/* left Fields  */}
